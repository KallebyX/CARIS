...
export default function PatientCalendarSettingsPage() {
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-2">
            Configure a integração com seus calendários externos para sincronizar automaticamente suas sessões.
          </p>
        </div>
        ...
        <Card className="bg-blue-50 border-blue-200">
          <CardContent className="pt-6">
            <div className="flex gap-4">
              ...
              <div className="space-y-2">
                <h4 className="font-semibold text-blue-900">Como funciona a sincronização?</h4>
                <p className="text-sm text-blue-800">
                  Quando você conecta seu calendário, todas as suas sessões agendadas serão
                  automaticamente sincronizadas. Você receberá lembretes de acordo com suas
                  preferências e qualquer alteração nas sessões será refletida em ambos os
                  calendários.
                </p>
              </div>
            </div>
